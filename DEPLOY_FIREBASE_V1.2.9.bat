...
echo ========================================
echo DEPLOY FIREBASE V1.2.9 - TaskGo
echo ========================================
echo.
echo Versão: 1.2.9
echo.
...
echo   - Correção: city/state salvos corretamente na raiz do documento
echo   - Correção: city/state aparecem no app para todos os usuários
echo   - Correção: ProfileViewModel salva city/state no UserFirestore
echo   - Correção: PublicUserProfileScreen lê city/state da raiz
echo.
echo ========================================
echo.
