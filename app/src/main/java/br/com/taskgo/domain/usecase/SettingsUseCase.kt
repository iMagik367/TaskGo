package br.com.taskgo.taskgo.domain.usecase

import com.example.taskgoapp.domain.repository.PreferencesRepository
...
class SettingsUseCase @Inject constructor(
    ...
    fun observeSettings(): Flow<SettingsState> {
        return combine(
            ...
            SettingsState(
                ...
                currentUser = values[7] as com.example.taskgoapp.core.model.UserProfile?
            )
        }
    }
    ...
    suspend fun updateUserProfile(user: com.example.taskgoapp.core.model.UserProfile) {
...
data class SettingsState(
    ...
    val currentUser: com.example.taskgoapp.core.model.UserProfile?
)
