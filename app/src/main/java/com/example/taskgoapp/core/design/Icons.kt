...
object TGIcons {
    ...
    @DrawableRes val Delete = R.drawable.ic_check // Usando ícone de confirmação como delete
    @DrawableRes val Add = R.drawable.ic_add // Agora usando o ícone correto de adicionar
    @DrawableRes val Send = R.drawable.ic_mensagens
    @DrawableRes val Star = R.drawable.ic_star // Agora usando o ícone correto de estrela
    @DrawableRes val Check = R.drawable.ic_check
    @DrawableRes val Close = R.drawable.ic_back // Usando ícone de voltar como close
