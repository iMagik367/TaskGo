...
import com.example.taskgoapp.domain.usecase.SettingsUseCase
...
class SettingsViewModel @Inject constructor(
    ...
    val state: StateFlow<com.example.taskgoapp.domain.usecase.SettingsState> =
        settingsUseCase.observeSettings().stateIn(viewModelScope, SharingStarted.WhileSubscribed(5_000),
            com.example.taskgoapp.domain.usecase.SettingsState(
                promosEnabled = true,
                soundEnabled = true,
                pushEnabled = true,
