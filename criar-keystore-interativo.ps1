# Script PowerShell Interativo - Execute manualmente no PowerShell
# 
# INSTRUCOES:
# 1. Abra o PowerShell na raiz do projeto
# 2. Execute: .\criar-keystore-interativo.ps1
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "========================================" -ForegroundColor Cyan
        Write-Host ""
        Write-Host "1. O .gitignore ja esta configurado corretamente" -ForegroundColor Green
        Write-Host ""
